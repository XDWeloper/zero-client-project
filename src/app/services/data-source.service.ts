...
export class DataSourceService {
  ...
  createDataSourceList(currentDocument?: IceDocument){
    this.dataSourceList.splice(0, this.dataSourceList.length)
    if(currentDocument && currentDocument.docAttrib && currentDocument.docAttrib.dataSourceList)
      currentDocument.docAttrib.dataSourceList.forEach(item => {
        this.dataSourceList.push(IceDataSource.builder(item))
      })
  }

  getDataSourceById(id: number): IceDataSource{
    return this.dataSourceList.find(item => item.id === id)
  }
  ...
  getDataMapValue(dataSource: IceDataSource, currentDocument?: IceDocument): Observable<DataSourceMap[]> {

    this.clearMap()    //обнулить
    ...
    if(dataSource.isNativeSource){ /**Запрос на наш бэк черз БФФ*/
      ...
      return this.http.post(environment.bffURI + '/operation', operation)
        .pipe(
        tap(value => {
          let valRes = JSON.stringify(value).replaceAll("\\\"", "\\\\\\\"")
    ...
    let value
      try{
        value = JSON.parse(depVal2)
      } catch (e){
      return throwError(() => new Error((e as Error).message))
      }
      this.reverseValue(value)
      return of(this.dataSourceMap)
    }
  }

  getDataForTest(dataSource: IceDataSource, currentDocument?: IceDocument): Observable<any> {
    this.clearMap()    //обнулить
  ...
  parseJsonObject(object: any): Observable<any>{
    this.clearMap()    //обнулить
  ...
  reverseValue(object: any) {
    ...
    key.forEach(objectKey => {
      ...
      if (isNaN(Number(objectKey)))
          ...
          this.currentKeyPath = "[]" + this.currentKeyPath
        }
        ...
        if ((typeof val) === "string" || (typeof val) === "number" ) {
          if ((typeof val) === "string")
            val = val.replaceAll("\\\"","\"")
          this.dataSourceMap.push({key: this.currentKeyPath, value: val})
...
export const depVal = "{\"department\":[{\"number\": 0,\"name\": \"Открытое Акционерное Общество Коммерческого Банка Флора-Москва\",\"filial\": \"1\",\"code\": \"00\"},{\"number\": 1,\"name\": \"ОАО КБ Флора-Москва 125\",\"filial\": \"1\",\"code\": \"013\"}]}"
export const depVal1 = "{\"departments\":[{\"number\":0,\"name\":\"Открытое Акционерное Общество Коммерческого Банка Флора-Москва\"\",\"filial\":\"1\",\"code\":\"00\"},{\"number\":1,\"name\":\"ОАО КБ Флора-Москва\"125\",\"filial\":\"1\",\"code\":\"013\"},{\"number\":2,\"name\":\"Открытое Акционерное Общество Коммерческого Банка Флора-Москва\",\"filial\":\"1\",\"code\":\"02\"},{\"number\":3,\"name\":\"Отделение №3 Черемушки\",\"filial\":\"1\",\"code\":\"75\"},{\"number\":4,\"name\":\"Отделение - 4 г.Окуловкаeee\",\"filial\":\"1\",\"code\":\"04\"},{\"number\":5,\"name\":\"Отделение 5\",\"filial\":\"1\",\"code\":null},{\"number\":6,\"name\":\"Отделение - 6 ул. Великая\",\"filial\":\"1\",\"code\":\"06\"},{\"number\":7,\"name\":\"Индивидуальный предприниматель  Зао \"Бфд\"\",\"filial\":\"1\",\"code\":\"07\"},{\"number\":8,\"name\":\"Индивидуальный предприниматель Б Зао \"Бфд\" 123\",\"filial\":\"1\",\"code\":\"01\"},{\"number\":9,\"name\":\"9е отделение\",\"filial\":\"1\",\"code\":null},{\"number\":10,\"name\":\"Центральная бухгалтерия\",\"filial\":\"1\",\"code\":\"10\"},{\"number\":11,\"name\":\"Физическое лицо\",\"filial\":\"1\",\"code\":\"01\"},{\"number\":15,\"name\":\"БРИНКС\",\"filial\":\"1\",\"code\":null},{\"number\":30,\"name\":\"Отделение 30, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":null},{\"number\":40,\"name\":\"ШАР ПЕЙ СИДЯЧ\",\"filial\":\"1\",\"code\":null},{\"number\":50,\"name\":\"Отделение 50, НОВОСИБИРСКОГО ФИЛИАЛА1\",\"filial\":\"1\",\"code\":null},{\"number\":66,\"name\":\"Закрытое акционерное общество \"Пигмей\"\",\"filial\":\"1\",\"code\":\"10\"},{\"number\":77,\"name\":\"Тестовый филиал\",\"filial\":\"1\",\"code\":\"77\"},{\"number\":99,\"name\":\"ИП Б З. \".\",\"filial\":\"1\",\"code\":\"99\"},{\"number\":100,\"name\":\"Ахмедшина ОЛЬГА ОЛЕГОВНА\",\"filial\":\"1\",\"code\":null},{\"number\":123,\"name\":\"Отделение милиции №123\",\"filial\":\"1\",\"code\":\"456\"},{\"number\":180,\"name\":\"Отделение 180\",\"filial\":\"1\",\"code\":null},{\"number\":250,\"name\":\"Отделение 250\",\"filial\":\"1\",\"code\":null},{\"number\":270,\"name\":\"Отделение 270\",\"filial\":\"1\",\"code\":null},{\"number\":290,\"name\":\"Отделение 290\",\"filial\":\"1\",\"code\":null},{\"number\":370,\"name\":\"Отделение 370\",\"filial\":\"1\",\"code\":null},{\"number\":450,\"name\":\"Отделение 450\",\"filial\":\"1\",\"code\":null},{\"number\":453,\"name\":\"Отделение 453\",\"filial\":\"1\",\"code\":null},{\"number\":454,\"name\":\"Отделение 454\",\"filial\":\"1\",\"code\":null},{\"number\":456,\"name\":\"Отделение 456\",\"filial\":\"1\",\"code\":null},{\"number\":457,\"name\":\"Отделение 457\",\"filial\":\"1\",\"code\":null},{\"number\":459,\"name\":\"ВОРОHА HА РУКУ в уп.12 в коробе 360шт\",\"filial\":\"1\",\"code\":\"36\"},{\"number\":555,\"name\":\"Индивидуальный предприниматель Б Зао \"Бфд\"\",\"filial\":\"1\",\"code\":\"11\"},{\"number\":600,\"name\":\"Отделение 600, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":null},{\"number\":650,\"name\":\"Отделение 650, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":null},{\"number\":690,\"name\":\"Отделение 690, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":null},{\"number\":700,\"name\":\"Отделение 700, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":null},{\"number\":750,\"name\":\"Отделение 750 23\",\"filial\":\"1\",\"code\":null},{\"number\":920,\"name\":\"Отделение 920\",\"filial\":\"1\",\"code\":null},{\"number\":990,\"name\":\"Отделение 990, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":null},{\"number\":991,\"name\":\"Открытое Акционерное Общество Коммерческого Банка Флора-Москва\"1\",\"filial\":\"1\",\"code\":null},{\"number\":992,\"name\":\"Отделение 992, НОВОСИБИРСКОГО ФИЛИАЛА\",\"filial\":\"1\",\"code\":\"0\"},{\"number\":993,\"name\":\"ОАО КБ \"Флора - Москва\"\",\"filial\":\"1\",\"code\":\"00\"},{\"number\":994,\"name\":\"Самая главная голова\",\"filial\":\"1\",\"code\":null},{\"number\":1000,\"name\":\"Жанар\",\"filial\":\"1\",\"code\":null},{\"number\":1001,\"name\":\"Отделение 1001 (Zoe) для клиентов\",\"filial\":\"1\",\"code\":null},{\"number\":4028,\"name\":\"Открытое Акционерное Общество Коммерческого Банка Флора-Москва\"\",\"filial\":\"1\",\"code\":\"05\"},{\"number\":8000,\"name\":\"СЕДОВ Михаил ВАСИЛЬЕВИЧ\",\"filial\":\"1\",\"code\":null}]}"
export const depVal2 = "{\"departments\":[{\"number\":1,\"name\":\"ОАО КБ Флора-Москва\\\"125\",\"filial\":\"1\",\"code\":\"013\"}]}"
