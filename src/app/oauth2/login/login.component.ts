...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activatedRoute.queryParams.subscribe(params => {
      ...
      // 1) если в запросе 'прилетел' параметр code - значит мы успешно авторизовались и пришел ответ от KC (потому что в redirect_uri указывали текущую страницу)
      ...
      if(params['redirect']){
        ...
        if(params['redirect'] === "losspass")
          this.router.navigate(['lossPass']);
        return;
      }
